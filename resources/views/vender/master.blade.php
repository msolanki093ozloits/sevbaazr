...
<body class="">
    ...
    -->
            ...
            <div class="logo"><a href="{{ url('VendorDashboard')}}" class="simple-text logo-mini">
             &nbsp &nbsp  SEV &nbsp BAZAAR VENDOR
             <br>
            ...
            <div class="sidebar-wrapper">
                ...
                <div class="user">
                    ...
                    <div class="user-info">
                        <a  class="username">
                            <span>
                       @if(Session::has('venderid'))
    {{ Session::get('Firm_name') }}
@endif 
                      <!--<b class="caret"></b>-->
                    </span>
                        </a>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse" id="pagesExamples">
                            <ul class="nav">
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{url('VendorProduct')}}">
                                        <span class="sidebar-mini"> AD </span>
                                        <span class="sidebar-normal"> Add Product </span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{url('VendorManageProduct')}}">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link"  href="{{url('VendorManageOrder')}}">
             ...
             <li class="nav-item ">
                        <a class="nav-link"  href="{{url('VendorCompletedOrder')}}">
                            <i class="material-icons">apps</i>
                            <p> Completed Order's
                                <!--<b class="caret"></b>-->
                            </p>
                        ...
                        <li class="nav-item ">
                        <a class="nav-link"  href="{{url('VendorCancelOrder')}}">
                            <i class="material-icons">apps</i>
                            <p> Cancel Order's
                                <!--<b class="caret"></b>-->
                            </p>
                        ...
                        <li class="nav-item ">
                        <a class="nav-link"  href="{{url('VendorOngoingOrder')}}">
                            <i class="material-icons">apps</i>
                            <p> Ongoing Order's
                                <!--<b class="caret"></b>-->
                            </p>
                        ...
                        <li class="nav-item ">
                        <a class="nav-link"  href="{{url('VendorReturnOrder')}}">
                            <i class="material-icons">apps</i>
                            <p> Return Order's
                                <!--<b class="caret"></b>-->
                            </p>
                   ...
                   <!--  <li class="nav-item ">
                        ...
                        <div class="collapse" id="pagesExamples1">
                            <ul class="nav">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{url('VendorManageSale')}}">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" d href="{{url('VendorManagePayment')}}">
                            <i class="material-icons">image</i>
                            <p> Manage payment
                                <!--<b class="caret"></b>-->
                            </p>
        ...
        <div class="main-panel">
             @include('vender.include.header_afterlogin')
			<!-- Navbar -->
...
@include('vender.include.footer_afterlogin')
                            ...
                            @include('vender.include.setting')
