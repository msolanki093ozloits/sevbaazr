        ...
        <div class="page-header login-page header-filter" filter-color="black" style="background-image: url({{ asset('images/backend_img/login.jpg') }}); background-size: cover; background-position: top center;">
            ...
            <div class="container">
                <div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
                    <form class="form" method="Post" action="{{url('VendorDashboard')}}">
                        @csrf
...
@endif
              ...
              <div class="input-group">
                ...
                <input type="email" class="form-control" placeholder="Email..." name="Firm_email" required>
            </div>
            </span>
            <span class="bmd-form-group">
              <div class="input-group">
        ...
        <input type="password" class="form-control" placeholder="Password..." name="Firm_password" required>
    </div>
    </span>
    </div>
   ...
   <!--   Core JS Files   -->
	...
	<script src="{{ asset('css/jquery.sharrre.js')}}"></script>
