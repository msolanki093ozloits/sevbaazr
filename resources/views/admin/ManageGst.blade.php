...
@csrf
              ...
              <!-- end notice modal -->
                                                ...
                                                <tr>
                                                    <td>2</td>
                                                    <td>Min. Order</td>
                                                    <td>{{ $product['0']['Min_order']}}</td>
                                                   
                                                  <td class="text-right">
                <a href="#" class="btn btn-link btn-info btn-just-icon visibility" data-toggle="modal" data-target="#noticeModalorder" rel="tooltip" data-placement="bottom" title="View"><i class="material-icons">art_track</i></a>

                </td>
                                                </tr>
                                                
                                                
                                                <div class="modal fade" id="noticeModalorder" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-notice">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="myModalLabel">Update Min order</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        <i class="material-icons">close</i>
                      </button>
                    </div>
                    <div class="modal-body">
                      <div class="instruction">
                        <div class="row">
                          <div class="col-md-12">
							 <form id="RegisterValidation" action="{{url('updateminorder')}}" method="Post" enctype="multipart/form-data">
@csrf
                                <div class="card ">
                                    <div class="card-header card-header-rose card-header-icon">
                                        <div class="card-icon">
                                        ...
                                        <h4 class="card-title">Min Order Update</h4>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleEmail" class="bmd-label-floating">Min Order *</label>
                                            <input type="text" class="form-control" id="exampleEmail"  name="Min_order"  value="{{ $product['0']['Min_order']}}" required>
