...
@endif
                              ...
                              <a href="javascript:void(0);" onclick="changeBannerStatus(0,{{ $pr->product_id}});"><img src="{{ asset('images/bullet_green.png') }}" width="32" height="32" title="click to deactive this Brand." /></a>@endif @if($pr->product_status==0)<a href="javascript:void(0);" onclick="changeBannerStatus(1,{{ $pr->product_id}});"><img src="{{ asset('images/bullet_red.png') }}" width="32" height="32" title="click to Aeactive this Brand." /> </a>@endif</td>
            ...
            <a href="{{url('/DeleteProduct')}}/{{ $pr->product_id}}" onclick="return confirm('Are you sure want Delete This Product')" class="btn btn-link btn-danger btn-just-icon remove" rel="tooltip" data-placement="bottom" title="Remove"><i class="material-icons">close</i></a>
                                                      ...
                                                      <a href="#" class="btn btn-link btn-info btn-just-icon visibility" data-toggle="modal" data-target="#noticeModalcomment" onclick="viewcomment({{ $pr->product_id}})" rel="tooltip" data-placement="bottom" title="Offer"><i class="material-icons">comment</i></a>
                                                    </td>
                                                </tr>
                      ...
                      <div class="instruction">
                        <div class="row">
                          <div class="col-md-8">
							...
							<div class="row">
							  <div class="col-md-6 p-1"><b>Product_price500g(Rs.)</b></div>
							  <div class="col-md-6 p-1">{{ $pr->product_price500}}</div>
							</div><!--/row-->
							<div class="row">
							  <div class="col-md-6 p-1"><b>Product_price400g(Rs.)</b></div>
							  <div class="col-md-6 p-1">{{ $pr->product_price400}}</div>
							</div><!--/row-->
							<div class="row">
							  <div class="col-md-6 p-1"><b>Product_price350g(Rs.)</b></div>
							  <div class="col-md-6 p-1">{{ $pr->product_price350}}</div>
							</div><!--/row-->
							<div class="row">
