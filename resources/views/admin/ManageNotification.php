                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $pr->Title}}</td>
                                                    <td>{{ $pr->NotiDesc}}</td>
                                                    <td><img src="{{ $pr->main_img}}" /></td>
                                                   
                                                    <td class="text-right">
                
            <a href="{{url('/DeleteProduct')}}/{{ $pr->notification_id}}" onclick="return confirm('Are you sure want Delete This Product')" class="btn btn-link btn-danger btn-just-icon remove" rel="tooltip" data-placement="bottom" title="Remove"><i class="material-icons">close</i></a>
