...
<div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="RegisterValidation" action="{{url('Banner')}}" method="Post" enctype="multipart/form-data">
@csrf
                                <div class="card ">
...
@endif
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker" name="region_id" data-style="select-with-transition" title="Brand City"  data-size="7" required>
