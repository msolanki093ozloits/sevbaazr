...
@endif
           ...
           <!--                             </div>-->
                                            ...
                                            <div class="col-sm-9 checkbox-radios">
                                                ...
                                                <div class="form-check text-left form-check-inline">
                                                    <label class="form-check-label text-dark">
                                                       <input class="form-check-input" type="checkbox" name="unit[]" value="{{$res['unit_id']}}" > {{$res['Unit']}}{{$res['UnitType']}}
                      ...
                      <span class="check"></span>
                                                 ...
                                                 <label for="exampleEmail" class="bmd-label-floating"> Product Price {{$res['Unit']}}{{$res['UnitType']}} *</label>
                                                <input type="text" class="form-control" id="exampleEmail"  name="unitprice[]" >
                                                @endforeach
