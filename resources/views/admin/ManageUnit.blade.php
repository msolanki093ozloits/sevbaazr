                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $count }}</td>
                                                    <td>{{ $pr->Unit}}{{ $pr->UnitType}}</td>
                                                    <!--<td><img style="height: 60px;" src="{{ $pr->main_img}}" class="rounded img-fluid"></td>-->
                                                    <td class="text-right">
                
                <a href="{{url('/EditUnit')}}/{{ $pr->unit_id}}" class="btn btn-link btn-warning btn-just-icon edit" rel="tooltip" data-placement="bottom" title="Edit"><i class="material-icons">dvr</i></a>

            <!--<a href="{{url('/DeleteRegion')}}/{{ $pr->unit_id}}" onclick="return confirm('Are you sure want Delete This Product')" class="btn btn-link btn-danger btn-just-icon remove" rel="tooltip" data-placement="bottom" title="Remove"><i class="material-icons">close</i></a>-->
                                                    </td>
                                                </tr>
                                                <!-- notice modal -->
              <div class="modal fade" id="noticeModal{{ $pr->unit_id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
