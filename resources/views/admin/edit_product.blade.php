...
<div class="row">
                      ...
                      <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        ...
                        <div class="fileinput-preview  thumbnail" style="">
                            <img src="{{ $productDetails->main_img}}" alt="..." style="height: 90px;">
                      ...
                      <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        ...
                        <div class="fileinput-preview  thumbnail" style="">
                            @if(!empty($productDetails->optional_img))
                           
                            
                            <img src="{{ $productDetails->optional_img}}" alt="..." style="height: 90px;">
                            @else
                             <img src="{{asset('images/backend_img/image_placeholder.jpg')}}" alt="..." style="height: 90px;">
