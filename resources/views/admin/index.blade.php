...
@endif
              ...
              <div class="input-group">
                ...
                <input type="email" name="Firm_email" class="form-control" placeholder="Email..." required>
            </div>
            </span>
            <span class="bmd-form-group">
              <div class="input-group">
        ...
        <input type="password" name="Firm_password" class="form-control" placeholder="Password..." required>
    </div>
    </span>
    </div>
