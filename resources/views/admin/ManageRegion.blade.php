...
@section('submenu')
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('Region')}}">Add City</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('ManageRegion')}}">Manage City</a>
                            </li>
...
@endif
                ...
                <a href="{{url('/EditRegion')}}/{{ $pr->region_id}}" class="btn btn-link btn-warning btn-just-icon edit" rel="tooltip" data-placement="bottom" title="Edit"><i class="material-icons">dvr</i></a>

            <a href="{{url('/DeleteRegion')}}/{{ $pr->region_id}}" onclick="return confirm('Are you sure want Delete This Product')" class="btn btn-link btn-danger btn-just-icon remove" rel="tooltip" data-placement="bottom" title="Remove"><i class="material-icons">close</i></a>
                                                    </td>
                                                </tr>
                                                <!-- notice modal -->
              <div class="modal fade" id="noticeModal{{ $pr->region_id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
