...
Route::any('webhook/order-tracking', function() {
    return "true";
});
...
Route::match(['get','post'],'/vendorstatus','AdminController@vendorstatus');
Route::match(['get','post'],'/vendorstatusdel','AdminController@vendorstatusdel');
...
Route::match(['get','post'],'/Banner','AdminController@Banner');
Route::get('/ManageBanner','AdminController@ManageBanner');

Route::match(['get','post'],'/OffersBanner','AdminController@OffersBanner');
Route::get('/ManageOffersBanner','AdminController@ManageOffersBanner');
...
/* vender */
Route::get('/SellerLogin','VenderController@login');
...
Route::post('/sellerviewcomment','VenderController@viewcomment');
Route::post('/sellerviewdis','VenderController@viewdis');

Route::post('/orderviewdis','VenderController@orderviewdis');

Route::post('/sellerUpdateProductOffer','VenderController@UpdateProductOffer');


Route::post('/VendorUpdateProduct','VenderController@UpdateProduct');
Route::post('/VendorUpdateProductprice','VenderController@UpdateProductprice');
...
Route::get('/VendorCompletedOrder','VenderController@CompletedOrder');
Route::get('/VendorCancelOrder','VenderController@CancelOrder');
Route::get('/VendorOngoingOrder','VenderController@OngoingOrder');
Route::get('/VendorReturnOrder','VenderController@ReturnOrder');
